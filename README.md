...
For the current version of this repository, only the Option 1 (single Agent) is solved 
...
In the file Report.pdf you can find a detailed explanation of the solution,
